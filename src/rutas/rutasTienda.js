...
router.get('/listarXCategoria', query('id').isInt().withMessage('Debe enviar el id de la categoría'), 
...
body('telefono').isNumeric().withMessage('Ingrese un número de teléfono válido'), controladorTienda.guardar);
...
body('telefono').isNumeric().withMessage('Ingrese un número de teléfono válido'), controladorTienda.modificar);
