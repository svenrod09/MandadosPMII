...
export default function AgregarImagenCScreen({ route, navigation }) {
    ...
    if (!APIData) {
        Alert.alert("MANDADITOS", "No existe ninguna categoría.");
        navigation.goBack();
        return null;
    }
    ...
    return (
        <><Appbar.Header style={styles.colorPrimary}>
            ...
            <ScrollView>
                <TouchableOpacity>
                    {APIData.map((element) => (
                        <Card key={element.idCategorias} style={styles.container} onPress={() => navigation.navigate('SeleccionarImagenCScreen', {
                            idCategorias: element.idCategorias
                        })}>
