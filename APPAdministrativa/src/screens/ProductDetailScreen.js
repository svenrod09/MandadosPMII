...
export default function ProductDetailScreen({ route, navigation }) {
    const { idproductos, nombreProducto, precioProducto, imagen, UserId } = route.params;
    ...
    const btnPressed = async () => {
        ...
        if (cantidadError) {
          setCantidad({ ...cantidad, error: cantidadError })      
            ...
            navigation.navigate('PedidosScreen', {idproductos: idproductos, nombreProducto: nombreProducto, precioProducto: precioProducto, imagen: imagen,  cantidad: cantidad.value, UserId: UserId})
        } 
    }
    return (
