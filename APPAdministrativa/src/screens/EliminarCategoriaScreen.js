...
export default function EliminarCategoriaScreen({ route, navigation }) {
    ...
    return (
        ...
        <TouchableOpacity>
          {APIData.map((element) => (
            <Card key={element.idCategorias} style={styles.container} onPress={() => navigation.navigate('DesactivarCategoriaScreen', { id: element.idCategorias, 
