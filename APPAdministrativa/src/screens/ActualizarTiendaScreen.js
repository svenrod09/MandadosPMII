...
export default function ActualizarTiendaScreen({ route, navigation }) {
    ...
    const btnPressed = async () => {
        ...
        if (nombreError || telefonoError || direccionError) {
            ...
            axios.put("http://192.168.1.9:5000/api/tienda/modificar?id=" + idTienda, {
                    id: idTienda,
                    nombre: nombre.value,
    ...
    return (
        <><Appbar.Header style={styles.colorPrimary}>
            ...
            <Appbar.Content title="Modificar Tienda" />
